...
It is in essence similar to the caching functionality of knitr[^knitroptions], available from the console; i.e., without having to *knit* the document to profit from the cache. 

[^knitroptions]: see the *cache* section of the [knitr options](http://yihui.name/knitr/options) documentation.
